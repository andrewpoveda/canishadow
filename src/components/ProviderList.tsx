...
// PRM.md §5.3 meta row — provider count + specialties, expandable to per-provider yes/no.
export default function ProviderList({ clinic }: { clinic: Clinic }) {
  ...
  return (
    <div className="mt-3">
      ...
      >
        {clinic.provider_count}{" "}
        {clinic.provider_count === 1 ? "PROVIDER" : "PROVIDERS"}
        ...
        <div className="mt-1 rounded-sheet bg-paper-2 px-4 py-3">
          {providers.length === 0 ? (
            <p className="text-[13px] text-ink-3">
              No individual provider responses logged yet.
            </p>
          ) : (
